...
public class ReadAggregateExecutionSerialStrategy<RequestModel, TModel> {
  public BongoDbBatchCursor<TModel> execute(
    ...
    //    var findRequestConverter = new
    // BongoFindRequestConverter(codec.converter(BsonDocument.class));
